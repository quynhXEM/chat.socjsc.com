...
- You will need access to the **VPN** ([docs](https://gitlab.connect.socjsc.com/new-vector/internal/-/wikis/SRE/Tailscale)) to be able to follow the instructions under Deploy below.
...
- [ ] Announce the release in [#element-web-announcements:connect.socjsc.com](https://matrix.to/#/#element-web-announcements:connect.socjsc.com)
