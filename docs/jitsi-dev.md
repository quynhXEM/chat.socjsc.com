...
example, a custom widget added in an integration manager for https://connect.socjsc.com will
end up creating a widget with a URL like `https://integrations.example.org?widgetUrl=https%3A%2F%2Fconnect.socjsc.com`.
